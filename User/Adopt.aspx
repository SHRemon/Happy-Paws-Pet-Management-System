<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Adopt.aspx.cs" Inherits="HappyPaws.User.Adopt" %>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-5 col-md-4">
                    ...
                    <div class="job-category-listing mb-50 pb-0">
                        ...
                        <div class="single-listing">
                            ...
                            <!-- Select Pet items start -->
                            <div class="select-job-items2">
                                <asp:DropDownList ID="Location" runat="server" name="select" CssClass="form-control w-100"
                                    DataSourceID="SqlDataSource1" AppendDataBoundItems="True" DataTextField="LocationName"
                                    DataValueField="LocationName" OnSelectedIndexChanged="Location_SelectedIndexChanged"
                                    AutoPostBack="true">
                ...
                <div class="col-xl-9 col-lg-7 col-md-8">
                    ...
                    <section class="featured-job-area">
                        <div class="container">
                            <!-- Count of Pet list Start -->
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="count-job mb-35">
                                        <asp:Label ID="lblpetCount" runat="server"></asp:Label>
                                    </div>
                                </div>
                            </div>
                            <!-- Count of Pet list End -->
                            <!-- single-Pet-content -->
                                    ...
                                    <div class="single-job-items mb-30">
                                        <div class="job-items">
                                            <div class="company-img">
                                                <a href="PetDetails.aspx?id=<%# Eval("AdoptId") %>">
                                                    <img width="80" src="<%# GetImageUrl( Eval("PetImage")) %>" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="items-link items-link2 f-right">
                                            <a href="PetDetails.aspx?id=<%# Eval("AdoptId") %>"><%# Eval("PetType") %></a>
