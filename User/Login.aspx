<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="HappyPaws.User.Login" %>
                 ...
                 <div class="col-lg-6 mx-auto">
                     <div class="form-contact contact_form">
                         <div class="row">
                             ...
                             <div class="col-12">
                                  <div class="form-group">
                                      ...
                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Login Type is required"
                         ...
                         <div class="form-group mt-3">
                            ...
                            <span class="clickLink"><a href="../User/Register.aspx">New User? Register Now!</a></span>
                        </div>
