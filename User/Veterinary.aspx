<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Veterinary.aspx.cs" Inherits="HappyPaws.User.Veterinary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container pt-50 pb-40">
        <div class="row">
                ...
                <div class="col-12">
                    <h2 class="contact-title text-center">Veterinary</h2>
                </div>
                <div class="col-lg-6 mx-auto">
                    <div class="form-contact contact_form">
                            ...
                            <div class="col-12">
                              ...
                              <div class="col-12">
                                   <div class="form-group">
                                       ...
                                       <asp:TextBox ID="txtReason" runat="server" CssClass="form-control" placeholder="Enter Reason for Visit" TextMode="MultiLine" required>
                                       </asp:TextBox>
                                   </div>
                               </div>
                               <div class="col-12">
                        ...
                        <div class="form-group mt-3">
                            <asp:Button ID="btnRequestVet" runat="server" Text="Request Veterinary" CssClass="button button-contactForm boxed-btn mr-4" OnClick="btnRequestVet_Click"/>
