<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="HappyPaws.User.Register" %>
        ...
        <div class="row">
                ...
                <div class="col-lg-6 mx-auto">
                    <div class="form-contact contact_form">
                        ...
                        <div class="form-group mt-3">
                            <span class="clickLink"><a href="../User/Login.aspx">Already Register? Login Now!</a></span>
                        </div>
                       </div>
                    </div>
                </div>
