<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/EmployeeMaster.Master" AutoEventWireup="true" CodeBehind="Bookings.aspx.cs" Inherits="HappyPaws.Employee.Bookings" %>
            ...
            <div class="row mb-3 pt-sm-3">
                <div class="col-md-12">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" HeaderStyle-HorizontalAlign="Center"
                        ...
                        OnPageIndexChanging="GridView1_PageIndexChanging" DataKeyNames="BookingID" OnRowDeleting="GridView1_RowDeleting">
                        <Columns>
                            ...
                            <asp:BoundField DataField="PetType" HeaderText="Pet Type">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
