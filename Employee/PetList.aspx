<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/EmployeeMaster.Master" AutoEventWireup="true" CodeBehind="PetList.aspx.cs" Inherits="HappyPaws.Employee.PetList" %>
        ...
        <div class="row mb-3 pt-sm-3">
            <div class="col-md-12">
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered"
                    ...
                    OnPageIndexChanging="GridView1_PageIndexChanging" DataKeyNames="AdoptId" OnRowDeleting="GridView1_RowDeleting"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnEditPet" runat="server" CommandName="EditPet" CommandArgument='<%# Eval("AdoptId") %>'>
